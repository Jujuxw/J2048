...
@interface DefaultTheme : NSObject <JTheme>
...
@interface VibrantTheme : NSObject <JTheme>

@end
@implementation VibrantTheme
...
@interface JoyfulTheme : NSObject <JTheme>

@end
@implementation JoyfulTheme
...
@implementation JTheme

+ (Class)themeClassForType:(NSInteger)type{
    switch (type) {
        case 1:
            return [VibrantTheme class];
            break;
        case 2:
            return [JoyfulTheme class];
            break;
        default:
